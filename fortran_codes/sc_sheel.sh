...
ifort -O3 -mcmodel=medium -heap-arrays 100000 -o a.out 3d_vtk_v2_1e4_sheel.f90 -L/opt/lapack-3.5.0 -llapack -L/opt/BLAS-3.6.0 -lblas /home/sheel/Work/system_utilities/tecplot10/lib/tecio64.a -lstdc++
